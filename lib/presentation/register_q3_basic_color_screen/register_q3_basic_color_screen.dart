...
class RegisterQ3BasicColorScreen
  ...
  RegisterQ3BasicColorController controller = RegisterQ3BasicColorController();

  List<DropdownMenuItem<String>> get dropdownItems{
    List<DropdownMenuItem<String>> menuItems = [
      DropdownMenuItem(child: Text("Yes"),value: "Citizen"),
      DropdownMenuItem(child: Text("No"),value: "Not citizen"),
    ];
    return menuItems;
  }
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Text(
                                                "Are you a Singaporean Citizen".tr,
                                                overflow: TextOverflow.ellipsis,
                              ...
                              Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: () {
                                        RegForm.from.citizen(controller.selected.value);
