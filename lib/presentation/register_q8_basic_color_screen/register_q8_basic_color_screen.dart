...
class RegisterQ8BasicColorScreen
    extends GetWidget<RegisterQ8BasicColorController> {

  RegisterQ8BasicColorController controller = RegisterQ8BasicColorController();
