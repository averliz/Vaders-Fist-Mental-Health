...
class Group288ItemWidget extends StatelessWidget {
  Group288ItemWidget(this.group288ItemModelObj);

  Group288ItemModel group288ItemModelObj;

  var controller = Get.find<LoginType1Controller>();
