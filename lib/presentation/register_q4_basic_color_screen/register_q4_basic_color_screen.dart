...
class RegisterQ4BasicColorScreen
    extends GetWidget<RegisterQ4BasicColorController> {

  RegisterQ4BasicColorController controller = RegisterQ4BasicColorController();

  List<DropdownMenuItem<String>> get dropdownItems{
    List<DropdownMenuItem<String>> menuItems = [
      DropdownMenuItem(child: Text("Moderate"),value: "Moderate"),
      DropdownMenuItem(child: Text("Vigorous"),value: "Vigorous"),
    ];
    return menuItems;
  }
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Text(
                                                "How would you describe your participation in recreational activities?".tr,
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: ElevatedButton(
                                          ...
                                          onPressed: () {
                                            RegForm.from.recreational(controller.selected.value);
