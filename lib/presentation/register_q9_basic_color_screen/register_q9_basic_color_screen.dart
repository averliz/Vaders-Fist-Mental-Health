...
class RegisterQ9BasicColorScreen
    extends GetWidget<RegisterQ9BasicColorController> {

  RegisterQ9BasicColorController controller = RegisterQ9BasicColorController();
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Text(
                                                "Have you been experiencing memory-related issues?".tr,
                                          ...
                                          Padding(
                                            ...
                                            child: Container(
                                              ...
                                              child: ElevatedButton(
                                                ...
                                                onPressed: () {
                                                  RegForm.from.memory(controller.selected.value);
                                                  Get.to(RegisterQ10BasicColorScreen());
                                                },
                                                child: Text(
                                                    'Next Question'
                                                ),
